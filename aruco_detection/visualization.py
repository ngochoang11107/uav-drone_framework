...
from transformation import rotation_to_euler, camera_in_marker
import detector
...
def draw_detection(frame, det, camera_matrix, dist_coeffs, marker_size, y= 30, ambiguity_warn=0.7, to_cm = 1.0, show_marker_frame=True ):
    ...
    y = _put(frame, f"x ={x:.1f} y={yy:.1f} z={z:.1f}cm",y, GREEN)
